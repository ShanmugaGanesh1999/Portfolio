...
export default function Hero() {
  ...
  return (
    <section className="space-y-4" id="hero">
      ...
      <pre className="text-accent leading-none text-[6px] sm:text-[8px] md:text-[10px] overflow-x-auto animate-fade-in-up animate-delay-200">
        {ASCII_ART}
      </pre>

      <div className="bg-border/30 border-l-4 border-accent p-4 animate-fade-in-up animate-delay-300">
