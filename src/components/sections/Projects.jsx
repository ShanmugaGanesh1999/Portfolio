...
function AsciiArtPreview() {
  return (
    <div className="h-32 bg-sidebar border-b border-border flex items-center justify-center overflow-hidden relative">
      <pre className="text-[6px] text-success/50 leading-[5px] select-none">
        {`  /|   /|   /|   /|   /|   /|   /|   /|   /|
 / |  / |  / |  / |  / |  / |  / |  / |  / |
|  |_|  |_|  |_|  |_|  |_|  |_|  |_|  |_|  |
|                                          |
...
function ProjectCard({ project }) {
  ...
  if (progress !== undefined) {
    return (
      <TerminalWindow className="p-4 flex flex-col justify-between bg-sidebar/40">
        <div>
          {subtitle && (
  ...
  if (highlight) {
    return (
      <TerminalWindow className="p-4 flex flex-col justify-between">
        <div>
          <h3 className="text-variable font-bold">{title}</h3>
