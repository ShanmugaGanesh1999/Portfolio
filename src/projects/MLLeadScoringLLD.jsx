...
// ──────────────────────────────────────
// Code File Tabs — Python source files
// ──────────────────────────────────────
...
// ──────────────────────────────────────
// MLLeadScoringLLD — Full LLD page
// ──────────────────────────────────────
    ...
    <div className="space-y-10">
      ...
      >
        <div className="space-y-4">
          ...
          {/* Key APIs */}
          <h3 className="text-sm text-variable font-bold pt-2">Key APIs</h3>
          <div className="space-y-2">
            {KEY_APIS.map((api) => (
              <div
                key={api.signature}
      ...
      <Section
        id="lld-code"
        command="find src/ -name '*.py' | xargs cat"
        defaultOpen={true}
      >
        <CodeFileTabs />
      </Section>
      ...
      >
        <div className="space-y-4">
          <h3 className="text-sm text-variable font-bold">Patterns Used</h3>
          <div className="space-y-2">
